...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    //check for the permission of the phone
    ...
    //For accessing the current location without even closing the app
    ...
    Location oldLocation;// so that when we move then only map should update
    class myThread extends Thread{
        ...
        public void run(){
            while (true) try {
                ...
                oldLocation = MyLocationListener.location;//Jab location change huyi tab hi update karnge
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (int i = 0; i < ListPockemons.size(); i++) {
                            ...
                            //checking if the pokemon is catched or not
                            if (pockemon.isCatch == false) {
                                ...
                                // catch the pockemn
                                if (MyLocationListener.location.distanceTo(pockemon.location) < 2)// if distance is less than two
                                {
    ...
    void LoadPockemon(){
        //Longitude and latitude are defined beforehand, we can add the location as per our location i.e. nearest to our location
...
//mMap.addPolyline
//mMap.addPolygon
//StreetPanoramaFragment for street view
//Different Function:
//streetViewPanorama.setPosition(new LatLng())
//streetViewPanorama.setStreetNameEnabled(true)
